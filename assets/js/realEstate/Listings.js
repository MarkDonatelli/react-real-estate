...
export default class Listings extends Component {
  ...
  render () {
    ...
    <div className="listing">
      ...
      <span className="address">75 Temple Ave</span>
      ...
      <div className="user-details">
        ...
        <span className="post-date">05/08/19</span>
      </div>
      <div className="listing-details">
      <div className="floor-space"><i className="fa fa-square-o" aria-hidden="true"></i> <span>1000 ft&sup2;</span></div>
      <div className="bedrooms"><i className="fa fa-bed" aria-hidden="true"></i><span>3 bedrooms</span></div>
      </div>
